...
public class Comments implements Serializable {
    ...
    public void setToNewsId(String toNewsId) {
        this.toNewsId = toNewsId == null ? null : toNewsId.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getToNewsId() == null ? other.getToNewsId() == null : this.getToNewsId().equals(other.getToNewsId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getToNewsId() == null) ? 0 : getToNewsId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", toNewsId=").append(toNewsId);

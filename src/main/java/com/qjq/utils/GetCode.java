...
public class GetCode {
    ...
    private static final String ACCOUNT_SID="fddb5530f4234d1c9b724fbccf06f6cb";
    private static final String AUTH_TOKEN="ea6dfc6a8d3f471199aba7270813cd05";
    ...
    public static String getCode(String phone){
        ...
        String tamp="【同校活动互动吧】尊敬的用户，您的验证码为"+rod+"，如非本人操作请忽略此短信。";
